...
import 'package:frontend/views/widgets/custom_bottom_button.dart';
  ...
  class DriverLicenseListScreen extends StatefulWidget {
    ...
    @override
    State<DriverLicenseListScreen> createState() => _DriverLicenseListScreenState();
  }
                  ...
                  return GestureDetector(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => DriverLicenseScreen(license: license),
                        ),
                      );
                    },
                    child: Container(
                        ...
                        children: [
                          Container(
                            ...
                            decoration: ShapeDecoration(
                              image: DecorationImage(
                                image: NetworkImage(
                                  license.frontImage.isNotEmpty ? license.frontImage : 'https://via.placeholder.com/150',
                                  ),
                                  fit: BoxFit.cover,
                              ),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                CustomTextBodyMsb(
                                  title: license.classLicense.toUpperCase(),
                                ),
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: ShapeDecoration(
                                        color:
                                            license.status.toLowerCase() == 'approved'
